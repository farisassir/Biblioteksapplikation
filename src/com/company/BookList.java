...
public class BookList implements Serializable {
    ...
    public Book isBookAvailable(String bookName) {
        ...
        System.out.println("This Book already loaned");
        return null;
    }
    ...
    public Book findBookWithAuthor(String name) {
        ...
        for (Book author : authors) {
            if ( author.getAuthor().toLowerCase().contains(name.toLowerCase())) {
                return author;
            }
        }
    ...
    public Book findBookWithBookName(String name) {
        ...
        for (Book bookName : names) {
            if ( bookName.getBookName().toLowerCase().contains(name.toLowerCase())){
            }
            return bookName;
        }
